...
export class AuthRoutingModule {
  static components = [LoginComponent, JoinComponent, ForgotPasswordComponent, ResetPasswordComponent, OtpComponent, AlreadyLoggedinComponent, ForceLogoutComponent];
}
