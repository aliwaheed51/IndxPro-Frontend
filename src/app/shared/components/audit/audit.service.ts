...
export class AuditService {
  ...
  getAuditReasonDropDown(modulelId: number): Observable<AuditReasonModel[]> {
    return this.utils.data.get<AuditReasonModel[]>(`AuditReason/GetAuditReasonByModuleDropDown`, modulelId);
  }
