...
@Component({
  selector: 'app-beneficiary-categoryList',
  templateUrl: './beneficiary-categoryList.component.html',
})
export class BeneficiaryCategoryListComponent extends MasterPage<BeneficiaryCategoryModel> implements OnInit {
  constructor(public service: BeneficiaryCategoryService, private formBuilder: FormBuilder, private utils: UtilityService,) { super(service); }
  @ViewChild(DataBindingDirective) dataBinding: DataBindingDirective;
  public gridView: any[];
  gridData: BeneficiaryCategoryModel[];
  data: any;
  ngOnInit(): void {
    this.GetData();
  }
