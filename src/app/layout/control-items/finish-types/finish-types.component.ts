...
@Component({
  selector: 'app-finish-types',
  templateUrl: './finish-types.component.html',
})
export class FinishTypesComponent extends MasterPage<FinishTypesModel> implements OnInit {
  profilePicPath: any;
  fileModel: FileModel;
  companies: any;
  @Input() data: any;
  ...
  constructor(public service: FinishTypesService, private utils: UtilityService, private formBuilder: FormBuilder) {
    super(service);
  }
  ...
  initForm(): void {
    this.form = this.formBuilder.group({
      finishCode: ['', Validators.required],
